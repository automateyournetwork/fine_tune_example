...
def main():
    ...
    generate_training_dataset(questions)
...
def generate_training_dataset(questions):
    ...
    for question in questions:
        training_data.append({
            "context": role,
            "prompt": question,
            "chosen": "",  # You can fill this with chosen responses if available
            "rejected": ""  # You can fill this with rejected responses if available
        })
